...
class TourGuide {
    ...
    prepare() {
        ...
        addTourItem("nav", "Navigation", 4, "Über diese Links kannst du zwischen den Kategorien hin und her wechseln.");
        addTourItem(".tasks li:not(.description)", 5, "Aufgaben", "Du kannst jede Aufgabe einzeln bearbeiten und dir theoretisch selber aussuchen wo du startest. Wir empfehlen aber, dass du alle Shorts in der vorgegebenen Reihenfolge bearbeitest.");
        addTourItem(".tasks li:not(.description) .description", 6, "Aufgabenbeschreibung", "Hier siehst du die eigentliche Aufgabenbeschreibung: Das solltest du programmieren.");
        ...
        addTourItem(".tasks li:not(.description) .actions [data-action=\"starter\"]", 9, "Starterpaket", "Wie immer bekommst du von uns ein Starterpaket mit dem du direkt loslegen kannst. Alles was du zum Bearbeiten der Aufgabe brauchst, findest du dort.");
        addTourItem(".tasks li:not(.description) .actions [data-action=\"support\"]", 10, "Fragen und Antworten", "Falls du mal nicht weiter weißt, kannst du uns im Discord schreiben. Über diesen Link erreichst du den richtigen Kanal für diese Frage.");
        ...
        addTourItem(".tasks li:not(.description)", 13, "Los geht's!", "Das war's! Viel Erfolg beim Wiederholen!");
    }
